exports.up = (pgm) => {
  // Add phase column to drills table
  pgm.addColumn('drills', {
    phase: { type: 'varchar(20)', notNull: true, default: 'Main Activity' },
  })
  ...
  pgm.sql(`
    ...
    WHERE s.id = (SELECT id FROM squads LIMIT 1);
  `)
}

exports.down = (pgm) => {
  pgm.sql(`DELETE FROM drills WHERE name IN (
