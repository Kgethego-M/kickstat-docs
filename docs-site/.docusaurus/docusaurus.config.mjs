...
export default {
    ...
    [
      "classic",
      {
        "docs": {
          ...
          "editUrl": "https://sdp.ms.wits.ac.za/bug-off/sport-coaching-tool/_edit/main/docs-site/"
        },
        "blog": false,
        "theme": {
  ...
  "themeConfig": {
    ...
    "footer": {
      ...
      "copyright": "Copyright © 2026 Sport Coaching Tool. Built with Docusaurus."
    },
    "prism": {
      "theme": {
        "plain": {
